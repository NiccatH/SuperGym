...
/* harmony import */ var _modules_video_video__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/video/video */ "./js/modules/video/video.js");
/* harmony import */ var _modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/tabs/tabs */ "./js/modules/tabs/tabs.js");
/* harmony import */ var _modules_phone_phone__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/phone/phone */ "./js/modules/phone/phone.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Modules
  // ---------------------------------
  Object(_modules_video_video__WEBPACK_IMPORTED_MODULE_0__["initVideo"])();
  Object(_modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_1__["initTabs"])();
  Object(_modules_phone_phone__WEBPACK_IMPORTED_MODULE_2__["initPhoneValidation"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
/***/ "./js/modules/phone/phone.js":
/*!***********************************!*\
  !*** ./js/modules/phone/phone.js ***!
  \***********************************/
/*! exports provided: initPhoneValidation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPhoneValidation", function() { return initPhoneValidation; });
...
var tabsButtons = document.querySelectorAll('[data-tab-name]');
var tabsContents = document.querySelectorAll('[data-tab-content]');

var selectTabContent = function selectTabContent(data) {
...
var videoContainer = document.querySelector('.about__video-cover');
var cover = videoContainer.querySelector('.about__video-overlay');
var playButton = cover.querySelector('.about__video-btn');
...
var onPlayButtonClick = function onPlayButtonClick(evt) {
  ...
  if (playButton.parentElement.classList.contains('is-play')) {
    ...
    var src = playButton.dataset.src;
